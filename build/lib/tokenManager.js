...
class TokenManager {
    ...
    async getAccessToken() {
        ...
        try {
            ...
            try {
                ...
                this.adapter.log.warn(`[getAccessToken] Refresh failed, doing full login...${error instanceof Error ? error.message : ''}`);
    ...
    getCustomerId() {
        ...
        const customerId = this.tokenData ? String(this.tokenData.userId) : undefined;
